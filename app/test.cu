...
__global__ void reverse(Fbox* d_nums, Fbox *d_rev, int N, int B, int *sharedTime, int *finishTime)
{
...
__global__ void resetTime(int * time)
{
    *time = 0;
}
...
int main(int argc, char **argv)
{
    ...
    reverse<<<grid_size, BLOCK_SIZE, 49152>>>(d_nums, d_rev, N, B, sharedTime, finishTime);
