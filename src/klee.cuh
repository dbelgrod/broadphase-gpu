...
// instead of just having x by default and y on border (and not check z) we can
// also check z by hand this will give an idea of the speedup from a 2d concept
