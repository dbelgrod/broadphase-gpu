...
__global__ void get_collision_pairs(ccdgpu::Aabb * boxes, int * count, int2 * overlaps, int N, int G, const int nBoxesPerThread, long long * queries);
__global__ void get_collision_pairs_old(ccdgpu::Aabb * boxes, int * count, int2 * overlaps, int N, int G );
